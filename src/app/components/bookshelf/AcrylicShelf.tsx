export default function AcrylicShelf() {
    return (
        <div className="relative shrink-0 w-11/12 sm:w-11/12 lg:w-8/12 h-3 sm:h-5 rounded-sm sm:rounded-md border border-white/30 border-b-white/10 bg-linear-to-b from-white/20 via-sky-100/5 to-white/5 backdrop-blur-md shadow-[0_10px_25px_rgba(15,23,42,0.15),inset_0_1px_1px_rgba(255,255,255,0.4)]">
